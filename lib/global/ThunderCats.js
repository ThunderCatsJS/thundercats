...
function createContainer(options, Component) {
  /* istanbul ignore else */
  if (__DEV__) {
    _invariant2['default'](typeof options === 'object', '%s should get an options object but got %s', options);
  }
  /* istanbul ignore else */
  if (!Component) {
...
function getName(comp) {
  return comp.displayName || comp.constructor.displayName || comp.constructor.name;
}
