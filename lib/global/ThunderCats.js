    ...
    _createClass(_class, [{
      ...
      value: function componentWillMount() {
        ...
        if (thundercats.fetchAction) {
          /* istanbul ignore else */
          if (__DEV__) {
            _invariant2['default'](thundercats.fetchAction.split('.').length === 2, '%s fetch action should be in the form of ' + '`actionsClass.actionMethod` but was given %s', thundercats.fetchAction);
