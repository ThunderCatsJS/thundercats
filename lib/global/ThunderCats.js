...
},{"define-properties":8,"object-keys":10}],8:[function(require,module,exports){
'use strict';
...
},{"./waitFor":21,"debug":2,"invariant":5,"object.assign":7}],14:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./Actions":13,"./Render":16,"./Store":17,"./Translate":18,"debug":2,"invariant":5,"warning":12}],15:[function(require,module,exports){
(function (global){
'use strict';
...
},{"invariant":5,"react/lib/cloneWithProps":1}],16:[function(require,module,exports){
(function (global){
'use strict';
...
var debug = _debug2['default']('thundercats:render');
...
},{"./ContextWrapper":15,"./waitFor":21,"debug":2}],17:[function(require,module,exports){
(function (global){
'use strict';
...
function validateObservable(observable) {
  /* istanbul ignore else */
  if (__DEV__) {
    _invariant2['default'](isObservable(observable), 'register should get observables but was given %s', observable);
  }
  return observable;
}
...
var Register = {
  observable: function observable(obs, actionsArr, storeName) {
    ...
    _invariant2['default'](isObservable(obs), '%s should register observables but was given %s', storeName, obs);
...
var Store = (function (_Rx$Observable) {
  ...
  _createClass(Store, [{
    ...
    value: function _init() {
      ...
      _invariant2['default'](areObservable(operations), '"%s" actions should be an array of observables', this.displayName);
      ...
      this._operationsSubscription = _rx2['default'].Observable.merge(operations).filter(function (operation) {
        ...
        _invariant2['default'](typeof operation.replace === 'object' || typeof operation.transform === 'function' || typeof operation.set === 'object', 'invalid operation, ' + 'operations should have a replace(an object), ' + 'transform(a function), or set(an object) property but got %s', Object.keys(operation));

        if ('optimistic' in operation) {
          _invariant2['default'](isPromise(operation.optimistic) || isObservable(operation.optimistic), 'invalid operation, optimistic should be a promise or observable,' + 'given : %s', operation.optimistic);
        }
...
},{"./Actions":13,"./utils":20,"debug":2,"invariant":5,"node-uuid":6,"object.assign":7}],18:[function(require,module,exports){
(function (global){
'use strict';
...
var debug = _debug2['default']('thundercats:translate');
...
exports['default'] = {
  ...
  hydrate: function hydrate(storesObservable, catStateObservable) {
    return _rx2['default'].Observable.combineLatest([storesObservable, catStateObservable.tap(_utils.createObjectValidator('hydrate should get objects but got %s'))], function (store, stateMap) {
      return {
        store: store,
...
},{"./utils":20,"debug":2,"invariant":5,"object.assign":7}],19:[function(require,module,exports){
(function (global){
'use strict';
...
function getChildContext(childContextTypes, currentContext) {
  ...
  var compContext = _objectAssign2['default']({}, currentContext);
  // istanbul ignore else
...
function createContainer(options, Component) {
  /* istanbul ignore else */
  if (__DEV__) {
    _invariant2['default'](typeof options === 'object', 'createContainer should get an options object but got %s', options);
  }
  ...
  /* istanbul ignore else */
  if (__DEV__) {
    _invariant2['default'](Component.prototype && Component.prototype.render && Component.prototype.setState, 'createContainer should get a React Component but got %s', _utils.getName(Component) + 'Container');
  }
  ...
  return (function (_React$Component) {
    var _class = function (props, context) {
      ...
      /* istanbul ignore else */
      if (__DEV__) {
        _invariant2['default'](typeof context.cat === 'object', '%s should find an instance of the Cat in the context but got %s', _utils.getName(this), context.cat);
      }
      ...
      if (options.store) {
        ...
        verifyStore(_utils.getName(this), options.store, this.observableState);
        ...
        (function () {
          ...
          /* istanbul ignore else */
          if (__DEV__) {
            _invariant2['default'](typeof combineLatest === 'function', '%s should get a function for options.combineLatest with ' + ' options.stores but got %s', _utils.getName(_this2), combineLatest);
          }
          ...
          storeNames.forEach(function (storeName) {
            ...
            verifyStore(_utils.getName(_this2), storeName, store);
            stores.push(store);
      ...
      if (__DEV__ && (options.store || options.stores)) {
        _invariant2['default'](_utils.isObservable(this.observableState), '%s should get at a store but found none for %s', _utils.getName(this), options.store || options.stores);
      }
    ...
    _createClass(_class, [{
      ...
      value: function componentWillMount() {
        ...
        if (options.fetchAction) {
          /* istanbul ignore else */
          if (__DEV__) {
            _invariant2['default'](options.fetchAction.split('.').length === 2, '%s fetch action should be in the form of ' + '`actionsClass.actionMethod` but was given %s', _utils.getName(this), options.fetchAction);

            _invariant2['default'](typeof options.store === 'string' || typeof options.fetchWaitFor === 'string', '%s requires a store to wait for after fetch but was given %s', _utils.getName(this), options.store || options.fetchWaitFor);

            _invariant2['default'](typeof options.getPayload === 'function', '%s should get a function for options.getPayload but was given %s', _utils.getName(this), options.getPayload);
          }
          ...
          /* istanbul ignore else */
          if (__DEV__) {
            _invariant2['default'](fetchActionsInst && fetchActionsInst[fetchMethodName], '%s expected to find actions class for %s, but found %s', _utils.getName(this), options.fetchAction, fetchActionsInst);

            _invariant2['default'](_utils.isObservable(fetchStore), '%s should get an observable but got %s for %s', _utils.getName(this), fetchStore, options.fetchWaitFor);
          }

          debug('cat returned %s for %s for %s', fetchActionsInst.displayName, fetchActionsName, _utils.getName(this));

          var action = fetchActionsInst[fetchMethodName];

          if (cat.fetchMap) {
            debug('%s getPayload in componentWillMount', _utils.getName(this));
      ...
      value: function componentDidMount() {
        ...
        if (options.action && options.getPayload) {
          debug('%s fetching on componentDidMount', _utils.getName(this));
      ...
      value: function componentWillReceiveProps(nextProps, nextContext) {
        ...
        if (options.action && options.shouldContainerFetch && options.shouldContainerFetch(this.props, nextProps, this.context, nextContext)) {
          debug('%s fetching on componentWillReceiveProps', _utils.getName(this));
      ...
      value: function componentWillUnmount() {
        ...
        if (this.stateSubscription) {
          debug('%s disposing store subscription', _utils.getName(this));
      ...
      value: function storeOnNext(val) {
        debug('%s value updating', _utils.getName(this), val);
        this.setState(val);
      }
    }, {
      key: 'render',
...
},{"./utils":20,"debug":2,"invariant":5,"object.assign":7}],20:[function(require,module,exports){
'use strict';
...
},{"invariant":5}],21:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./utils":20,"debug":2}],22:[function(require,module,exports){
'use strict';
...
},{"./Actions":13,"./Cat":14,"./Store":17,"./createContainer":19,"./waitFor":21}]},{},[22])(22)
});