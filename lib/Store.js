...
export const Register = {
  observable(name, obs, actionsMap, storeName) {
    invariant(
      isObservable(obs),
  ...
  actions(actionsInst, actionsMap, storeName) {
    invariant(
      actionsInst instanceof Actions,
      '%s attempted to register non ThunderCats Actions object. Got %s',
      storeName,
      actionsInst
    );
    let actionNames = actionsInst.__getActionNames(actionsInst);
    ...
    actionNames.map(name => {
      Register.observable(name, actionsInst[name], actionsMap);
    });
