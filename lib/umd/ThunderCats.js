...
/***/ function(module, exports, __webpack_require__) {
	...
	function getNameOrNull(comp) {
	  return comp && comp.displayName || comp.constructor && comp.constructor.displayName || comp.fixed && comp.fixed.refs && comp.fixed.refs.displayName || null;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Store() {
	  ...
	  return stamp.init(function (_ref) {
	    var instance = _ref.instance;
	    return _rx.Observable.call(instance, methods._subscribe);
	  }).refs({
	    value: value,
	    ...
	    observers: new Map(),
	    history: new Map()
	  })['static'](staticMethods).methods(methods);
	}
