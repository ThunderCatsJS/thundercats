...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Cat2 = __webpack_require__(36);

	var _Cat3 = _interopRequireDefault(_Cat2);

	exports.Cat = _Cat3['default'];

	var _Store2 = __webpack_require__(37);

	var _Store3 = _interopRequireDefault(_Store2);

	exports.Store = _Store3['default'];

	var _Translate = __webpack_require__(38);

	Object.defineProperty(exports, 'dehydrate', {
	  enumerable: true,
	  get: function get() {
	    return _Translate.dehydrate;
	  }
	});
	Object.defineProperty(exports, 'hydrate', {
	  enumerable: true,
	  get: function get() {
	    return _Translate.hydrate;
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashLangIsFunction = __webpack_require__(23);

	var _lodashLangIsFunction2 = _interopRequireDefault(_lodashLangIsFunction);

	var _lodashLangIsObject = __webpack_require__(4);

	var _lodashLangIsObject2 = _interopRequireDefault(_lodashLangIsObject);

	var _supermixer = __webpack_require__(24);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mixer = __webpack_require__(62);

	var _mixer2 = _interopRequireDefault(_mixer);

	var _lodashLangIsFunction = __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stampit = __webpack_require__(11);
	...
	var _waitFor = __webpack_require__(39);
	...
	function create(shouldBind, _ref) {
	  ...
	  (0, _objectAssign2['default'])(action, _rx2['default'].Observable.prototype);
	...
	function createMany(shouldBind, instance) {
	  return this.map(create.bind(instance, shouldBind)).reduce(function (ctx, action) {
	...
	function Actions() {
	  ...
	  (0, _warning2['default'])(!displayName, '%s used displayName in spec, this will be deprecated in future versions', displayName);
	  return (0, _stampit2['default'])().refs({ displayName: displayName }).init(function (_ref2) {
	    var _context;

	    var instance = _ref2.instance;

	    var actionMethods = (_context = getActionDef(obj), createMany).call(_context, shouldBind, instance);
	    return (0, _objectAssign2['default'])(instance, actionMethods);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _nodeUuid = __webpack_require__(42);
	...
	function Store() {
	  ...
	  var stampSpec = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];
	  ...
	  (0, _objectAssign2['default'])(stamp, (0, _objectAssign2['default'])(stamp.fixed['static'], _rx.Observable));
	...
	(0, _objectAssign2['default'])(Store, staticMethods);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function dehydrate(cat) {
	  if (__DEV__) {
	    (0, _invariant2['default'])((0, _utils.isKitten)(cat), 'dehydrate should get an instance of the cat, but got %s', cat);
	  }

	  return _rx.Observable.from(cat.stores.values())
	...
	function hydrate(cat, storesState) {
	  if (__DEV__) {
	    (0, _invariant2['default'])((0, _utils.isKitten)(cat), 'dehydrate should get an instance of the cat, but got %s', cat);
	  }

	  return _rx.Observable.combineLatest([_rx.Observable.from(cat.stores.values()), _rx.Observable.just(storesState).tap((0, _utils.createObjectValidator)('hydrate should get objects but got %s'))], function (store, stateMap) {
	    return {
	      store: store,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayEach = __webpack_require__(48),
	    ...
	    createForEach = __webpack_require__(56);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashObjectForOwn = __webpack_require__(83);
	...
	var _lodashLangCloneDeep = __webpack_require__(79);
	...
	var _lodashLangIsUndefined = __webpack_require__(81);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseFor = __webpack_require__(25),
	    createForIn = __webpack_require__(71);
