...
Actions.prototype.__getActionNames = function() {
  var ctx = this;
  invariant(
...
Actions._createActions = function(actions, ctx) {
  warning(
    ctx instanceof Actions,
    'Attempting to create a actions function outside of ' +
    'an Actions object has been deprecated. Please use the class method ' +
    'to create an object that extends ThunderCats Actions class'
  );
  ...
  if (Array.isArray(actions)) {
    ...
    throw new TypeError(
      'Actions._createActions expects a string or an array but got %s',
      actions
    );
  }
