...
var ObservableStateMixin = {
  ...
  componentDidMount: function() {
    ...
    this._stateSubscription =
      this._observableState.subscribe(
        this._stateObserver,
...
function onError(err) {
  throw new Error('An error has occurred in the observable state: ' + err);
}

function onCompleted() {
  console.warn('observable state has terminated without error');
}
