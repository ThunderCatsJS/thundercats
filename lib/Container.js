...
class Container extends React.Component {
  ...
  componentWillMount() {
    ...
    if (cat.fetchMap && this.state.fetchClass) {
      ...
      const fetchCtx = {
        ...
        payload: this.props.fetchPayload || { transform: value => value },
        store: this.state.store,
        action: fetchActions[fetchMethod]
      };
      cat.fetchMap.set(fetchCtx.name, fetchCtx);
    }
  }
